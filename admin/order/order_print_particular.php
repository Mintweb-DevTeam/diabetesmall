...
?>
    <div class="<?= $classid;?>">
    <div id="<?= $classid;?>" style="position:relative;" >
		<p style="position:absolute; right:5px;top:80px; opacity:.7"><img src="/admin/image/adela_stamp.png" width="70px" alt="" /></p>
...
<?php
     //  for ($i = (count($data['goods']) + $linePlus); $i < 6; $i++) {
?>
            <!-- <tr height="22">
                <td>&nbsp;</td>
                <td>&nbsp;</td>
...
?>
		...
		<table id="box" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr height="22">
				...
				<td style="padding-left:6px" align="center">제품등록번호</td>
				<td style="padding-left:6px" align="center">센서 고유 No.(상품박스하단 확인)</td>
			</tr>
			<tr height="22">
				<td align="center">1</td>
				<td style="padding-left:6px">DMS0722000019</td>
