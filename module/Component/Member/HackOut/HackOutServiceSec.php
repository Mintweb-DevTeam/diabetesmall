 ...
 * @author  yjwee
 */
class HackOutServiceSec extends \Bundle\Component\Member\HackOut\HackOutService
{
    ...
    public function checkRejoinByMemberId($memberId, $required = true)
    {
        ...
        $returnData = [
            'isFl' => 'n',
            'message' => "회원탈퇴 후 ".$policy['rejoin']."일 동안 재가입할 수 없습니다. 회원님은 ".substr($this->hackOut['hackDt'], 0, 10)."에 탈퇴하셨습니다.",
        ];
        return $returnData;
    }
