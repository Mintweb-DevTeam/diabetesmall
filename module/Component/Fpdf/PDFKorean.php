...
public $UHC_widths = array(' '=>333,'!'=>416,'"'=>416,'#'=>833,'$'=>625,'%'=>916,'&'=>833,'\''=>250,
...
function _getfontpath()
{
	if(!defined('FPDF_FONTPATH') && is_dir(dirname(__FILE__).'/../../../fpdf/font'))
		define('FPDF_FONTPATH',dirname(__FILE__).'/../../../fodf/font/');
...
function MultiCells($w, $h, $txt, $border=0, $align='L', $fill=false)
{
	if($this->CurrentFont['type']=='Type0')
...
$html=strip_tags($html,"<div><b><u><i><a><img><p><br><strong><em><font><tr><blockquote><span><h4>");
$html=str_replace("\n",' ',$html); 
...
$this->Writes(8,stripslashes($this->txtentities($e)));
}
else{
if($e[0]=='/')
