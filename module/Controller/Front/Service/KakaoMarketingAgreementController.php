...
class KakaoMarketingAgreementController extends \Controller\Front\Controller
{
    public function index()
    {
        ...
        if(\Request::isMobileDevice()) {
            echo "
            <script>
            location.href='https://m.diabetesmall.co.kr/service/kakao_marketing_agreement.php';
            </script>
            ";
        }
    }
