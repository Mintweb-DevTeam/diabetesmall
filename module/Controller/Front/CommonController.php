	...
	public function index($controller)
	{
		...
		*/
        ...
        if ($request->request()->has('returnUrl')) {
            ...
            if ( strpos($phpSelf, 'member/kakao_connect.php') === false && strpos($phpSelf, 'member/join_membership.php') === false && strpos($phpSelf, 'member/sns_member.php') === false && strpos($phpSelf, 'member/join_kakao.php') === false && strpos($phpSelf, 'member/co_join_stepa.php') === false && strpos($phpSelf, 'member/login.php') === false && strpos($phpSelf, 'member/join_method.php') === false && strpos($phpSelf, '_ps.php') === false) {
