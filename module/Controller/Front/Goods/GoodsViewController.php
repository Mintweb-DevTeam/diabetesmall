...
class GoodsViewController extends \Bundle\Controller\Front\Goods\GoodsViewController
{
	public function index()
	{
			...
			//if( !Session::get('member.memNo') && ($goodsNo =="1000000079" || $goodsNo =="1000000077")){
			...
			//	$this->setData("kk",1);	
			//}		
		//if(\Request::getRemoteAddress()=="112.146.205.181"){
		 ...
		 //}
            ...
            if ($goodsView['isSubscription']){
				...
				if($now_date <= "2024-04-30"){
					...
					$fixedPrice = number_format(($goodsView['fixedPrice']+ $goodsView['option']['optionPrice'])*$goodsView['defaultGoodsCnt']);
