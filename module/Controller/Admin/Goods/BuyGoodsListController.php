...
class BuyGoodsListController extends \Controller\Admin\Controller
{
	...
	public function index()
	{
		...
		//if(\Request::getRemoteAddress() != "182.216.219.157"){
			//exit();	
		//}
        $this->callMenu('goods', 'goods', 'buy_goods_list');
        ...
        $this->getView()->setDefine("goodsSearchFrm", Request::getDirectoryUri() . "/goodsSearchForm4.php");
